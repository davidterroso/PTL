...
SAVE_ROOT = './results_topcon/'
SAVE_ROOT_ = './GT_topcon/'

def test_model():
    train_file = './outputs/train_data_.csv'
    test_file = './outputs/Topcon.csv'
    ...
    def plot_image(sample):
        ...
        save_filename_ = SAVE_ROOT_ + path
        ...
        img_array = sample[1].astype(np.int8)
        result = Image.fromarray(img_array)
        result.save(save_filename_)
