...
# Initialize arrays for the combined volume
gt_vol = []
result_vol = []
...
for index, row in volume_name_counts.iterrows():
    ...
    # Initialize arrays for the current volume
    current_gt_vol = []
    current_result_vol = []
...
results_df.to_csv(os.path.join(outputs_path, 'dice_coefficients_as_a_whole.csv'), index=False)